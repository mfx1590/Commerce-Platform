...
window 1 owns (registry, catalog, cart, checkout, orders, inventory); everything else stays on the Prism mocks (`pnpm mock`). Owner: window 1 (core);
