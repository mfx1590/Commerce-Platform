...
| `cms/` | 6 — CMS & landing pages | `cms/**`, `apps/storefront-starter/src/app/[locale]/(content)/**`, `apps/storefront-starter/src/app/api/cms/**`, `apps/storefront-starter/src/lib/cms/**`, `apps/storefront-starter/test/cms-*` |
