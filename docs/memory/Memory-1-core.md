...
## Done
- [x] **1.9 READMEs + CLAUDE.md + tests green (issue #9)** — 2026-09-07, on `core/phase1` after #71 merged; sha: see PR (filled at the next commit). `src/http/README.md`, `src/lib/README.md`, CLAUDE.md module table + build-first note; 65 tests green on the merged tree.
...
## In progress
- **Phase 1 tasks 1.1–1.9 delivered** (2026-09-07). Remaining Phase 1 follow-up: sort/order on Admin API list handlers (contracts 0.2.0) as one PR after #9 merges. Then Phase 2 waits for Memory-main.
