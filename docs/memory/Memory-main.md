...
- Done: step 1 monorepo skeleton (99d4661, 8681771) · step 2 docs/domain.md (66c2ca6) · operating guide docs/HOW-I-RUN-THIS.md (5603a1b) · step 3 ownership check + self-test + CI job (b23676f, 434b401) · step 4 packages/db migrations + RLS + tenant client + 10 isolation tests (8c33bb7) · step 5 packages/events 24 schemas + types + validator + outbox (pending sha)
- In progress: step 6 packages/contracts (OpenAPI store-api + admin-api, openapi-typescript types, Prism mock on :4010/:4011, contract tests)
