...
- **Merge round 2 (2026-09-06):** #61 core 1.2–1.7 merged (guard fix verified). #69 infra (images fix, job required again) and #65 auth (OTP conditional) merged. #66 storefront 1.4 BLOCK (409 details key `available`), #67 admin 1.5 BLOCK (variant creation unreachable, README/memory contradictions) — windows fixing. Decisions sent: #60 accept (window 1, ts-node devDependency), #68 accept (window 3, next.config.mjs), window 4 starts 1.6 locally, window 5 folds .dockerignore into 2.2.
